...
[![Github Build Status](https://github.com/turanszkij/CrucibleEngine/workflows/Build/badge.svg)](https://github.com/turanszkij/CrucibleEngine/actions)
[![Discord chat](https://img.shields.io/discord/602811659224088577?logo=discord)](https://discord.gg/CFjRYmE)
<a href="https://twitter.com/intent/follow?screen_name=Anthony_python"><img src="https://img.shields.io/twitter/follow/Anthony_python.svg?style=social" alt="follow on Twitter"></a>
<br/>
...
You can get the full source code by using Git version control and cloning https://github.com/Crucible-team/Crucible.git, or downloading it as zip. You can also download prebuilt and packaged version of the Editor here (requires Github sign in): [![Github Build Status](https://github.com/turanszkij/CrucibleEngine/workflows/Build/badge.svg)](https://github.com/turanszkij/CrucibleEngine/actions)
<br/>
<br/>
...
-- Print any CrucibleEngine class information to the backlog:
...
For more code samples and advanced use cases, please see the example projects, like the Template_Windows, Tests, or Editor project. There are also sample models and scripts included with Crucible Engine in the Content/models and Content/scripts folders. Check them out to learn about more features.
...
For further details, please check the scripting API documentation: [Crucible Engine Scripting API](Content/Documentation/ScriptingAPI-Documentation.md)


### Model import/export:
The native model format is the <b>WISCENE</b> format. Any application using Crucible Engine can open this format efficiently.
...
### Humaniod Bone mapping
The Editor supports VRM,HL1/HD, HL2 Bone names for Humaniod maps.

### FACS mappings
The Extended VRM has added support to have most FACS mappings.

The preferred workflow is to import models into the Editor, and save them as <b>WISCENE</b>, then any Crucible Engine application can open them.<br/>

<img align="right" src="https://github.com/turanszkij/Wickedengine-gifs/raw/main/snowstorm.gif" width="320px"/>

### Graphics API:
The default renderer is `DirectX 12` on Windows and `Vulkan` on Linux. The `DirectX 11` renderer is no longer available starting from version 0.57.0, but it can be found on the <a href="https://github.com/turanszkij/CrucibleEngine/tree/dx11-backup">dx11-backup branch</a>.
...
### Other software using Crucible Engine
