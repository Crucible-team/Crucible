...
void TerrainWindow::SetupAssets()
{
	...
	terrain_preset.material_Base.textures[MaterialComponent::BASECOLORMAP].name = wi::helper::GetCurrentPath() + "/Data/terrain/base.jpg";
	terrain_preset.material_Base.textures[MaterialComponent::NORMALMAP].name = wi::helper::GetCurrentPath() + "/Data/terrain/base_nor.jpg";
	terrain_preset.material_Slope.textures[MaterialComponent::BASECOLORMAP].name = wi::helper::GetCurrentPath() + "/Data/terrain/slope.jpg";
	terrain_preset.material_Slope.textures[MaterialComponent::NORMALMAP].name = wi::helper::GetCurrentPath() + "/Data/terrain/slope_nor.jpg";
	terrain_preset.material_LowAltitude.textures[MaterialComponent::BASECOLORMAP].name = wi::helper::GetCurrentPath() + "/Data/terrain/low_altitude.jpg";
	terrain_preset.material_LowAltitude.textures[MaterialComponent::NORMALMAP].name = wi::helper::GetCurrentPath() + "/Data/terrain/low_altitude_nor.jpg";
	terrain_preset.material_HighAltitude.textures[MaterialComponent::BASECOLORMAP].name = wi::helper::GetCurrentPath() + "/Data/terrain/high_altitude.jpg";
	terrain_preset.material_HighAltitude.textures[MaterialComponent::NORMALMAP].name = wi::helper::GetCurrentPath() + "/Data/terrain/high_altitude_nor.jpg";
	...
	std::string terrain_path = wi::helper::GetCurrentPath() + "/Data/terrain/";
